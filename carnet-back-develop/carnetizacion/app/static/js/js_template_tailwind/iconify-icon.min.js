...
!function () {
    ...
    const G = "iconify2", V = "iconify", K = V + "-count", W = V + "-version", X = 36e5;
    ...
    const Tt = {"background-color": "currentColor"}, Ft = {"background-color": "transparent"},
    ...
    function Lt(t, e) {
        ...
        if ("svg" === s) c = function (t) {
            ...
            const r = t.attributes, s = 'url("' + (u = Mt(i, {
                ...r,
                width: e.width + "",
                height: e.height + ""
            }), "data:image/svg+xml," + function (t) {
                return t.replace(/"/g, "'").replace(/%/g, "%25").replace(/#/g, "%23").replace(/</g, "%3C").replace(/>/g, "%3E").replace(/\s+/g, " ")
            }(u) + '")'), c = o.style, a = {"--svg": s, width: Rt(r.width), height: Rt(r.height), ...n ? Tt : Ft};
            var u;
    ...
    !function (t = "iconify-icon") {
        ...
        const i = ["icon", "mode", "inline", "width", "height", "rotate", "flip"], r = class extends n {
            ...
            constructor() {
                super();
                const t = this._shadowRoot = this.attachShadow({mode: "open"}), e = mt(this);
