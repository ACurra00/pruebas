...
class CrearCarnet(HttpUser):
    ...
    def mostrar_crear_carnet(self):
        ...
        with self.client.get(f"/crearUnMatriculado/{area}/{ci}",
                              data={
                                  "rol": "Seminterno",
                                   "annoEstudiantePersona": 4,
                                   "nombre": "Enmanuel de Jesus",
                                  "ci": "02032466727",
                                  "comprobante_motivo": "ok",
                                  "tipoPersona": "Student",
                                  "area": "Facultad de Ingenieria Informatica",
                                  "area_anterior": "Facultad de Ingenieria Informatica",
    ...
    def crear_carnet(self):
        ...
        with self.client.post(f"/crear_carnet/{area}/{ci}", data={
